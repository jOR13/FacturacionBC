report 50895 HG_NotaDeCredito
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultLayout = Word;
    //EnableExternalImages = true;
    WordLayout = 'Docs\HG_NotaDeCredito.docx';
    ...
    dataset
    {
        ...
        dataitem(NCTimbradas; NCTimbradas)
        {
            ...
            var
                myInt: Integer;
            begin
                eventHandler.DoGenerateBarcode(NCTimbradas."QR String", temp, NCTimbradas.UUID);
        ...
        dataitem("Cliente"; "Sales Cr.Memo Header")
        {
            ...
            column(UUIDRelacionadoNC; UUIDRelacionadoNC)
            {
            }
        ...
        dataitem(Conceptos; ConceptosNC)
        {
